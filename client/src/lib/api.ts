...
export const authApi = {
  login: (d: { username: string; password: string }) => api.post("/auth/login", d).then(r => r.data),
  superLogin: (d: { username: string; password: string }) => api.post("/auth/super/login", d).then(r => r.data),
  me: () => api.get("/auth/me").then(r => r.data),
  updateLanguage: (language: string) => api.patch("/auth/language", { language }).then(r => r.data),
  changePassword: (currentPassword: string, newPassword: string) => api.patch("/auth/change-password", { currentPassword, newPassword }).then(r => r.data),
};
...
export const milkApi = {
  list: (p?: any) => api.get("/milk", { params: p }).then(r => r.data),
...
export const reportsApi = {
  farmer: (farmerId: string, p?: any) => api.get(`/reports/farmer/${farmerId}`, { params: p }).then(r => r.data),
  monthly: (p?: any) => api.get("/reports/monthly", { params: p }).then(r => r.data),
  weekly: (p?: any) => api.get("/reports/weekly", { params: p }).then(r => r.data),
  exportCsv: (p?: any) => api.get("/reports/export/csv", { params: p, responseType: "blob" }).then(r => r.data),
};
export const paymentsApi = {
  list: (p?: any) => api.get("/payments", { params: p }).then(r => r.data),
  dues: () => api.get("/payments/dues").then(r => r.data),
  dailySummary: (date?: string) => api.get("/payments/daily-summary", { params: { date } }).then(r => r.data),
...
export const superAdminApi = {
  ...
  getDairyReport: (id: string, params?: any) => api.get(`/superadmin/dairies/${id}/report`, { params }).then(r => r.data),
  ...
  changeAdminPassword: (dairyId: string, adminId: string, newPassword: string) => api.patch(`/superadmin/dairies/${dairyId}/admin/${adminId}/password`, { newPassword }).then(r => r.data),
};
